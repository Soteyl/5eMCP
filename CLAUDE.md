...
- **Phase 4 (done):** Callable DM tools — `cr_calculate`, `cr_scale`, `encounter_build`, `loot_generate`. Completes the 1.0 featureset.
- **Phase 5 (post-1.0):** Express HTTP transport + Pantheon deploy.
